...
This program provide a organized data information of the rank of male and female baby's names.
The program has the function of adding the information in each filename document to a dictionary called data_name,
it also allows user to read the data of a year or search names they are looking for
"""
